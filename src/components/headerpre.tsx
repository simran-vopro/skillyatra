                ...
                <nav className="container mx-auto flex items-center justify-between h-16">
                    ...
                    <div className="flex-1 flex justify-center md:justify-start">
                        <Link to="/" className="font-bold text-xxl md:text-lg text-gray-800">
                            SkillsYatra<span className="w-1 h-1 bg-primary inline-block" />
                        </Link>
                    </div>
                                            ...
                                            {item.subItems?.map((label) => (
                                                <li key={label}>
                                                    <Link
                                                        ...
                                                        className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover-item"
                                                    >
                                                        {label}
                                                    </Link>
                                                </li>
            ...
            >
                <div className="flex flex-col h-full">
                    <div className="flex flex-col h-full p-6 space-y-6">
                        ...
                        >
                            SkillsYatra<span className="w-1 h-1 bg-primary inline-block"></span>
                        </Link>
